            ...
            >
                <div className="container px-4 mx-auto flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="md:hidden z-[1000] text-soft-mint hover:text-muted-sage transition-colors"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        transition={{ duration: 0.3 }}
                        className="fixed inset-0 z-[60] bg-midnight-green/60 backdrop-blur-md flex flex-col items-center justify-center md:hidden"
                    >

                        {/* Close Button (X) */}
                        <button
                            onClick={() => setIsOpen(false)}
                            className="absolute top-5 right-4 text-soft-mint hover:text-muted-sage transition-colors z-[1001]"
